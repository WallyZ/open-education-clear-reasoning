# Clear Reasoning Foundations

## Course Summary

A twelve-module foundations course for clear thought, proof, argument, rhetoric, dialogue, and disciplined disagreement.

- Level: foundational to advanced beginner
- Estimated time: 72 to 96 hours
- Format: readings, drills, written analysis, spoken performance, dialogue practice, capstone portfolio
- Prerequisites: literacy, willingness to revise, and willingness to represent opponents fairly
- Final deliverable: Clear Reasoning Capstone Portfolio

## Course Outcomes

By the end, the learner can:

- define and distinguish terms precisely
- map arguments and identify missing assumptions
- reconstruct proof-like reasoning
- use valid inference patterns
- detect common fallacies and manipulative moves
- ask ordered dialectical questions
...
- one source reading or source-reference briefing
- two short drills
...
A completed learner portfolio includes:
